...
//
// Struktur: pro Turnier ein Top-Level-Key (wm2026, cl2627, …) mit
...
window.POSITION_OVERRIDES = {
    ...
    // CL 2026/27: Durchsicht des Pools nach dem Transferschluss
    // (Stand 03.09.2026). Drei Stufen, in dieser Reihenfolge:
    //
