(function (global) {
  ...
  const BASE_BADGES = [
    ...
    },
    {
      ...
      label: 'TopCaptain',
      emoji: '👑',
      description: 'Dein Captain liefert aktuell richtig stark ab.',
    ...
    },
    {
      ...
      label: 'FlopCaptain',
      emoji: '🫠',
      description: 'Dein Captain zieht dein Team aktuell nach unten.',
    ...
    },
    {
      ...
      emoji: '🪑',
      description: 'Mindestens einer deiner Spieler wartet noch auf seinen ersten Einsatz, obwohl seine Nation bereits gespielt hat.',
    ...
    },
    {
      ...
      emoji: '🥶',
      description: 'Deine Spieler treffen aktuell kaum ins Tor.',
    ...
    },
    {
      ...
      label: 'Kartensammler',
      emoji: '🟨',
      description: 'Dein Team sammelt aktuell die meisten Karten.',
